...
def issue_reduce_code(reduce_file, reduce_server_ip, reduce_server_port, task_id, reissue_tasks):
    p = os.system(' '.join(['node', '../map-reduce/reduce/scheduler-reduce.js', reduce_file, task_id, reduce_server_ip, str(reduce_server_port)]))
...
def poll_reduce_server(output_file, reduce_server_ip, reduce_server_port, task_id):
    p = os.system(' '.join(['node', '../map-reduce/reduce/fetch-reduce.js', output_file, task_id, reduce_server_ip, str(reduce_server_port)]))
